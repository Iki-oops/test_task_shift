...
```
cd existing_repo
git remote add origin https://gitlab.com/shift1392926/test-task.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/shift1392926/test-task/-/settings/integrations)
